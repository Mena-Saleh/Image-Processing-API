...
var resizeImage = function (filename, width, height) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                sourcePath = path_1.default.join(__dirname, '..', '..', 'images', filename + '.jpg');
                outputPath = path_1.default.join(__dirname, '..', '..', 'images', 'resized');
                if (!!fs_1.default.existsSync(outputPath)) return [3 /*break*/, 2];
                return [4 /*yield*/, fs_1.default.mkdirSync(outputPath)];
            case 1:
                _a.sent();
                _a.label = 2;
            case 2: 
            ...
            return [4 /*yield*/, (0, sharp_1.default)(sourcePath)
                    .resize(width, height)
                    .toFile(path_1.default.join(outputPath, filename + '.jpg'), function (err) {
                    if (err != null)
                        console.log(err);
                })];
            case 3:
