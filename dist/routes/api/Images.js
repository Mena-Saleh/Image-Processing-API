...
images.get('/', function (req, res) {
    ...
    var sourcePath = path_1.default.join(__dirname, '..', '..', '..', 'images', name + '.jpg');
    var outputPath = path_1.default.join(__dirname, '..', '..', '..', 'images', 'resized', name + '.jpg');
    if (filename != null) {
